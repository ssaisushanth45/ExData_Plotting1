...
condata$Global_reactive_power<- as.numeric(condata$Global_reactive_power)
condata$Voltage <- as.numeric(condata$Voltage)
...
with(condata, plot(x= Day, y = condata$Global_active_power, ylab = "Global Active Power", xlab = "", type ="l"))

with(condata, plot(x= Day, y = condata$Voltage, ylab = "Voltage", xlab = "datetime", type ="l"))
...
with(condata, plot(x= Day, y = condata$Global_reactive_power, ylab = "Global Reactive Power", xlab = "datetime", type ="l"))


dev.copy(png, file = "C:/Users/ssais/Documents/11. Coursework/Data Science/4. Exploratory Data Analysis/ExData_Plotting1/Plot_4.png", width = 480, height = 480)
dev.off()